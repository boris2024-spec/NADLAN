                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="lg:col-span-1">
                            <Card className="p-6 text-center">
                                ...
                                <p className="text-gray-600 mb-4">{user?.role === 'agent' ? 'סוכן נדל"ן' : 'לקוח'}</p>
                            ...
                            <Card className="p-6 mt-6">
                                ...
                                <div className="space-y-4">
                                    <div className="flex justify-between">
                                        <span className="text-gray-600">נכסים שמורים</span>
                                        <span className="font-semibold">12</span>
                                    </div>
                                    <div className="flex justify-between">
                                        <span className="text-gray-600">צפיות בנכסים</span>
                                        <span className="font-semibold">45</span>
                                    </div>
                                    <div className="flex justify-between">
                                        <span className="text-gray-600">חיפושים שמורים</span>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        {isEditing ? (
                                            ...
                                            <p className="py-2 px-3 bg-gray-50 rounded-lg">{formData.email}</p>
                                        )}
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        {isEditing ? (
                                            ...
                                            <p className="py-2 px-3 bg-gray-50 rounded-lg">{formData.city}</p>
                                        )}
                                    </div>
                            ...
                            <Card className="p-6 mt-6">
                                ...
                                <div className="mt-6 pt-4 border-t border-gray-200">
                                    <div className="flex items-center justify-between">
                                        <div>
                                            <h4 className="font-medium text-gray-900">התראות אימייל</h4>
                                            <p className="text-sm text-gray-600">קבלו עדכונים על נכסים חדשים שמתאימים לכם</p>
                                        </div>
                                        <input
                                            type="checkbox"
